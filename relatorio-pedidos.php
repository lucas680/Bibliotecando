<?php
  include "control/conexao.php";
   ...
   require_once 'dompdf/autoload.inc.php';
    ...
    $sql = "SELECT * FROM pedidos, usuario, Livros where usu_status = 0 AND usuario.usu_codigo = pedidos.usu_codigo AND Livros.l_codigo = pedidos.l_codigo";
    $resultado = mysqli_query($conexao, $sql);

    $html= "<h2 style='text-align: center'>Relatório De Pedidos (Bibliotecando)</h2><br>";
